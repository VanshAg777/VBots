...
from pyrosim_old.nndf import NNDF

from pyrosim_old.linksdf  import LINK_SDF

from pyrosim_old.linkurdf import LINK_URDF

from pyrosim_old.model import MODEL

from pyrosim_old.sdf   import SDF

from pyrosim_old.urdf  import URDF

from pyrosim_old.joint import JOINT
...
def Get_Touch_Sensor_Value_For_Link(linkName):
    ...
    print("desiredLinkIndex",desiredLinkIndex)
    ...
    for pt in pts:
        ...
        linkIndex = pt[4]
        print("thisss:", linkIndex)


        if ( linkIndex == desiredLinkIndex ):

            touchValue = 1.0
            print("trueeeee:",linkIndex )

    return touchValue

def Get_Touch_Sensor_Value_For_Link_VA(linkName):
